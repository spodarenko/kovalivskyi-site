    ...
    <section id="standorte" style={{ background: 'var(--bg)' }}>
      <div style={{ maxWidth: 1180, margin: '0 auto', padding: '80px 24px' }}>
        <div className="area-map-wrap" style={{ position: 'relative', border: '1px solid var(--border)', borderRadius: 18, overflow: 'hidden', isolation: 'isolate' }}>
          ...
          <div className="area-panel" style={{ position: 'absolute', top: 16, left: 16, bottom: 16, zIndex: 1000, background: 'rgba(255,255,255,0.94)', backdropFilter: 'blur(8px)', borderRadius: 14, padding: '38px 32px', maxWidth: 440, boxShadow: '0 4px 28px rgba(0,0,0,0.10)', display: 'flex', flexDirection: 'column' }}>
