  ...
  return (
    <header style={{ position: 'sticky', top: 16, zIndex: 50, padding: '0 16px' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', background: 'var(--nav-bg, rgba(252,250,244,0.82))', backdropFilter: 'blur(14px)',
        ...
        <img src="./assets/kovalivskyi-logo.svg" alt="Kovalivskyi" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} style={{ height: 29.4, width: 'auto', display: 'block', cursor: 'pointer', marginLeft: 10 }} />
